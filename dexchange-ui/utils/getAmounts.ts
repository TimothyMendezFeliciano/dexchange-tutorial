 ...
 */
export const getEtherBalance = async (provider: any, address: any, contract = false) => {
    try {
 ...
 */
export const getPairATokensBalance = async (provider: any, address: any) => {
    try {
        ...
        const balanceOfPairATokens = await tokenContract.balanceOf(address);
        return balanceOfPairATokens;
    } catch (err) {
        console.error(err);
    }
};
